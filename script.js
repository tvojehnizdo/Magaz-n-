(function(){
  ...
  document.querySelectorAll("a[href^='https://']").forEach(a=>{try{const u=new URL(a.href);
    ["utm_source","utm_medium","utm_campaign"].forEach(k=>{ if(!u.searchParams.has(k)){ const t=utm.split("&").find(x=>x.startsWith(k)).split("="); u.searchParams.set(t[0],t[1]); }});
    a.href=u.toString(); }catch(_){ }});
})();
